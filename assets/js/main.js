...
/*----------------------------------------*/
	...
	function categorySubMenuToggle() {
		...
		if (screenSize <= 991) {
			...
			$('.category-menu .right-menu ul').slideUp(); /*slideUp*/
		} else {
			$('.category-menu .right-menu > a i').remove();
			$('.category-menu .right-menu ul').slideDown(); /*slideDown*/
		}
	}
...
/*----------------------------------------*/
	$('.umino-countdown').countdown('2020/12/20', function(event) {
		$(this).html(
			event.strftime(
				'<div class="count"><span class="count-amount">%D</span><span class="count-period">天</span></div><div class="count"><span class="count-amount">%H</span><span class="count-period">时</span></div><div class="count"><span class="count-amount">%M</span><span class="count-period">分</span></div><div class="count"><span class="count-amount">%S</span><span class="count-period">秒</span></div>'
			)
		);
	});
